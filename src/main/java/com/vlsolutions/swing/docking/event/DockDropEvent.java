 ...
 * <p>
 * This event is used by API extenders to manage drag and drop action related to docking. This is not meant to be used
 * by User Applications.
 *
 * <p>
 * The dockDropReceiver can accept or reject the drop.
 * <p>
 * If the drop is accepted, the receiver must process the docking operation, (usually by invoking a docking method on
 * the desktop).
 *
...
public class DockDropEvent extends DockEvent {
     ...
     * <p>
     * If the drop is accepted, the receiver must process the docking operation, (usually by invoking a docking method
     * on the desktop).
     * <p>
     * As of version 2.1, a DockingActionEvent has been added to the DockEvent class, adding a "semantic" description of
     * the docking operation. The DropReceiver must call setDockingAction() before acceptDrop().
     * <p>
     ...
     *
     * @param remove
     *            if true, the docking desktop will remove the dragged dockable from its containment hierarchy. If
     *            false, it is the responsibility of the DockDropReceiver to remove (or simply move) the dragged
     *            dockable.
     *            <p>
